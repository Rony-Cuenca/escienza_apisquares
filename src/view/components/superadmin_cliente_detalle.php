            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="index.php?controller=superadmin&action=impersonarCliente&id=<?= $cliente['id'] ?>"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-black font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-blue-100 text-sm font-medium">Establecimientos</p>
                            <p class="text-3xl font-bold"><?= count($establecimientos) ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-green-100 text-sm font-medium">Usuarios</p>
                ...
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-purple-100 text-sm font-medium">Tipo</p>
                            <p class="text-lg font-bold">Cliente Premium</p>
                        </div>
