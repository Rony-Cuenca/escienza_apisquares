<div class="flex flex-col items-center w-full px-[80px]">
    <div class="w-full max-w-7xl">
        ...
        <div class="overflow-x-auto md:overflow-x-visible">
            <div class="rounded-lg border-[2px] border-[#0018F4] bg-white mx-auto overflow-hidden">
        ...
        <form id="formUsuario" method="post" action="index.php?controller=usuario&action=crear" autocomplete="off">
            ...
            <div id="camposContrasena" class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                    ...
                    <input type="password" name="contraseña" id="modalUsuarioContraseña" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" autocomplete="new-password" />
                </div>
                <div>
                    <label class="block mb-1 font-semibold text-sm text-gray-700">Confirmar Contraseña</label>
                    <input type="password" name="confirmar_contraseña" id="modalUsuarioConfirmarContraseña" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" autocomplete="new-password" />
